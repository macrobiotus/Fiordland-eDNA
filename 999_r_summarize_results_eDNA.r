...
ggsave(
  "210401_998_r_summarize_results_fig1_map-eDNAonly.pdf",
  plot = last_plot(),
  device = "pdf",
...
ggsave(
  "210312_998_r_summarize_results_mca_dim1_eDNAonly.pdf",
  plot = last_plot(),
  device = "pdf",
  path = "/Users/paul/Documents/OU_eDNA/200403_manuscript/7_si_auxillary_files",
  scale = 1.3,
...
ggsave(
  "210408_998_r_summarize_results_mca_eDNAonly.pdf",
  plot = last_plot(),
  device = "pdf",
  path = "/Users/paul/Documents/OU_eDNA/200403_manuscript/7_si_auxillary_files",
  scale = 1,
