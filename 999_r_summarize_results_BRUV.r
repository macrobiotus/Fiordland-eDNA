...
ggsave("210401_998_r_summarize_results_fig1_map-BRUVonly.pdf", plot = last_plot(), device = "pdf", path = "/Users/paul/Documents/OU_eDNA/200403_manuscript/7_si_auxillary_files", 
...
ggsave("210407_998_r_summarize_results_observations-BRUVonly.pdf", plot = last_plot(), device = "pdf", path = "/Users/paul/Documents/OU_eDNA/200403_manuscript/7_si_auxillary_files", 
...
ggsave("210407_998_r_summarize_results_observations_heat_BRUVonly.pdf", plot = last_plot(), device = "pdf", path = "/Users/paul/Documents/OU_eDNA/200403_manuscript/7_si_auxillary_files", 
...
ggsave("210312_998_r_summarize_results_jaccard_BRUVonly.pdf", plot = last_plot(), device = "pdf", path = "/Users/paul/Documents/OU_eDNA/200403_manuscript/7_si_auxillary_files", 
...
ggsave("210312_998_r_summarize_results_mca_dim1_BRUVonly.pdf", plot = last_plot(), device = "pdf", path = "/Users/paul/Documents/OU_eDNA/200403_manuscript/7_si_auxillary_files", 
...
p_mca <- ggplot(data = mca1_obs_df, aes(x = Dim.1, y = Dim.2)) + geom_hline(yintercept = 0, colour = "gray70") + geom_vline(xintercept = 0, colour = "gray70") + geom_point(colour = "gray50", 
	...
	dim_2_perc, "% Variance)")) + annotation_custom(ggplotGrob(p_cntrb), xmin = -1.8, xmax = -0.8, ymin = 1.5, ymax = 2.3)

ggsave("210408_998_r_summarize_results_mca_BRUVonly.pdf", plot = last_plot(), device = "pdf", path = "/Users/paul/Documents/OU_eDNA/200403_manuscript/7_si_auxillary_files", 
