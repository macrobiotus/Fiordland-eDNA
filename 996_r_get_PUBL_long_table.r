...
library("dplyr")
library("tidyr")
library("rfishbase") # new 14-Dec-2022

Sys.setenv(ENTREZ_KEY="PutNcbiApiKeyHereTheOldOneIsDefunct")
...
# inspect synonyms
spc_in_syn %>% select(Species, synonym, Status)

# Correct literture list 
# ----------------------

# done manually using `spc_in_syn`: 
...
spc_in <- c(
  ...
  "Conger verreauxi", "Cryptichthys jojettae", "Eptatretus cirrahtus", "Fiordichthys slartibartfasti", 
  "Forsterygion flavonigrum", "Forsterygion lapillum", "Forsterygion malcolmi", "Forsterygion varium", 
  "Gaidropsarus novaezelandi", "Modicus minimus", "Gobiopsis atrata", "Forsterygion capito", "Helicolenus percoides", 
  "Hypoplectrodes huntii", "Karalepis stewarti", "Latridopsis ciliaris", "Latridopsis forsteri", "Latris lineata", 
  "Lepidoperca tasmanica", "Lissocampus filum", "Lotella rhacina", "Mendosoma lineatum", "Mendosoma lineatum", 
  "Modicus tangaroa", "Nemadactylus macropterus", "Notoclinops caerulepunctus", "Notoclinops segmentatus", 
  "Notoclinus fenestratus", "Notolabrus celidotus", "Notolabrus cinctus", "Notolabrus fucicola", "Forsterygion maryannae", 
...
spc_in[which(spc_read %!in% spc_in) ]   # in corrected list as "Forsterygion capito"
spc_read[which(spc_read %!in% spc_in) ] # in literture list as ""Grahamina capito"
...
# ---------------------------------------------------------------------------
#  "Hypoplectrodes huntii" - found 14.12.2022
...
unique(spc$GENUS); unique(spc$SPECIES) # formely:    34 Genera, 42 species fully resolved
                                       # 14-12-2022: 36 Genera, 44 species fully resolved
...
save.image(file = "/Users/paul/Documents/OU_eDNA/201028_Robjects/221214_996_r_get_PUBL_long_table__image.Rdata")
saveRDS(publ_obs, file = "/Users/paul/Documents/OU_eDNA/201028_Robjects/221214_996_r_get_PUBL_long_table__publ_obs.Rds")
saveRDS(publ_obs, file = "/Users/paul/Documents/OU_eDNA/200403_manuscript/5_online_repository/R_objects/221214_996_r_get_PUBL_long_table__publ_obs.Rds")
